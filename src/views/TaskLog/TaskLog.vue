    ...
    <div class="common-layout">
      <el-container style="height: 100vh;" direction="vertical">
        <el-header style="padding: 0; height: 150px;">
          <h1>CatHeadCat's Task Logs</h1>
          <div class="navigation-bar">
            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
              <el-sub-menu index="1">
                <template #title>Create New Task Log</template>
                <el-menu-item index="1-1"><router-link to="create_litera">Literature Reading Notes</router-link></el-menu-item>
                <el-menu-item index="1-2"><router-link to="create_summary">Summary of Recent Tasks</router-link></el-menu-item>
              </el-sub-menu>
